...
REPLY_POOLS: Dict[str, Dict] = {
    ...
    "identity": {
        "triggers": ["bondage", "foreplay", "Are you into foreplay and rough", "do you like it rough"],
        "responses": [
    ...
    "threesome": {
        "triggers": ["threesome", "triple", "mmf", "fmf","ffm", "do you like threesome, do you want us to invite someone to join us to make us three"],
        "responses": [
           " I really wish we could have this threesome like we agreed on. I just can wait to experience it, fucking my hole and sucking her pussy same time.",
    ...
    "dream": {
        "triggers": ["fantasy", "dream", "do you like fantasy, what is your fantasy"],
        "responses": [
    ...
    "scam": {
        "triggers": ["scam", "site", "games", "game", "leave", "I do not play games and this site is a scam"],
        "responses": [
